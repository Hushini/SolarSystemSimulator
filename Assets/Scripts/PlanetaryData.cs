...
/*
    Tabela elementów orbitalnych Keplera dla ośmiu planet.
    Dane: JPL, "Keplerian Elements for Approximate Positions of the Major Planets",
    E.M. Standish & J.G. Williams (1992). Tabela ważna dla lat 1800-2050.
    Źródło: https://ssd.jpl.nasa.gov/planets/approx_pos.html
*/
public static class PlanetaryData
{
    private static readonly Dictionary<Planet, KeplerianElements> table =
        new Dictionary<Planet, KeplerianElements>
    {
        { Planet.Mercury, new KeplerianElements(
        ...
        { Planet.Venus, new KeplerianElements(
        ...
        { Planet.Earth, new KeplerianElements(
        ...
        { Planet.Mars, new KeplerianElements(
        ...
        { Planet.Jupiter, new KeplerianElements(
        ...
        { Planet.Saturn, new KeplerianElements(
        ...
        { Planet.Uranus, new KeplerianElements(
        ...
        { Planet.Neptune, new KeplerianElements(
    ...
    // Zwraca elementy orbitalne wskazanej planety.
    public static KeplerianElements GetElements(Planet planet) => table[planet];
}